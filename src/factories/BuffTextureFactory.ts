...
export class BuffTextureFactory {

    public static generateRapidFireTexture(app: PIXI.Application): PIXI.Texture {
    ...
    public static generateShieldTexture(app: PIXI.Application): PIXI.Texture {
        const graphics = new PIXI.Graphics();
    ...
    public static generateExplosionTexture(app: PIXI.Application): PIXI.Texture {
        const graphics = new PIXI.Graphics();
